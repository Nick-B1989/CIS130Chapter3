...
// Declare the htmlCode variable with a value of empty string
let htmlCode = "";

// Create a for loop with a counter that goes from 0 to less than the length of the captions array in increments of 1.
for (let i = 0; i < captions.length; i++) {

    // With each iteration, add text to the value of the htmlCode variable.
    htmlCode += "<figure>";
...
// Update the inner HTML of the element with the ID "gallery"
