...
// Declare the htmlCode variable, setting it to empty string
let htmlCode = "";

// For loop, counter to less than titles array in increments of 1.
// With each iteration, add text to the value of htmlCode variable.
...
// Declare tableBody variable referencing the first and only element in the web documnet with the tag name "tbody".
